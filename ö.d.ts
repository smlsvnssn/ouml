...
export function wrapFirstWords(s: string, numWords?: number, startWrap?: string, endWrap?: string, startAtChar?: number): string;
export function toCamelCase(s: string): string;
export function toKebabCase(s: string): string;
export function randomChars(): string;

export function toHsla(c: string, asString?: boolean): string | {
    h: number;
    s: number;
    l: number;
    a: number;
